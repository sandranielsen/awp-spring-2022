...
function toysItems() {
  ...
  }, product.price, "$")))), /* @__PURE__ */ React.createElement(Form, null, "style=", {
    display: "inline"
  }, 'method="post" >', /* @__PURE__ */ React.createElement("input", null, /* @__PURE__ */ React.createElement("table", null)))))));
}
export {
  toysItems as default
};
//# sourceMappingURL=/build/routes/toys/index-VG37IIAY.js.map
