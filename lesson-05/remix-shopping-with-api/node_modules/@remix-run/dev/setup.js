...
(function (SetupPlatform) {
  ...
  SetupPlatform["Deno"] = "deno";
})(exports.SetupPlatform || (exports.SetupPlatform = {}));

function isSetupPlatform(platform) {
  return [exports.SetupPlatform.CloudflarePages, exports.SetupPlatform.CloudflareWorkers, exports.SetupPlatform.Node, exports.SetupPlatform.Deno].includes(platform);
}
async function setupRemix(platform) {
  ...
  let clientPkgJsonFile = resolvePackageJsonFile(`@remix-run/react`); // Update remix/package.json dependencies
